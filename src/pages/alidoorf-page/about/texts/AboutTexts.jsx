                ...
                <div className="texts__inner grid px2">
                    <div className="diver">
                        ...
                        <div className='margin'>
                            <p className='desc mb3'>{ result.data?.[`${type}_about_doors_txt2`] || '...' }</p>
                    ...
                    <div className='wrapper py3'>
                        <div className="titles">
                            <div className='txt'>{ result.data?.[`${type}_about_doors_sub`] || '...' }</div>
                            <h1 className="title fw300 pb2">{ result.data?.[`${type}_about_doors_tit`] || '...' }</h1>
                        </div>
                        <h3 className="desc fw500 mb2">{ result.data?.[`${type}_about_doors_txt1`] || '...' }</h3>
                        <p className='desc'>{ result.data?.[`${type}_about_doors_txt3`] || '...' }</p>
                        <p className="desc">{ result.data?.[`${type}_about_doors_txt4`] || '...' }</p>
