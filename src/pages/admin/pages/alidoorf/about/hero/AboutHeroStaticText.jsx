...
const AboutHeroStaticText = () => {
    ...
    useEffect(() => {
        setTitRu(result?.data?.ali_about_hero_static_txt_ru)
        setTitEn(result?.data?.ali_about_hero_static_txt_en)
        setTitUz(result?.data?.ali_about_hero_static_txt_uz)
    }, [result, effect])


    return (
        <AdminForm
            value='ali_about_hero_static_txt'
            valueRu={titRu}
            valueEn={titEn}
            valueUz={titUz}
            setValueRu={setTitRu}
