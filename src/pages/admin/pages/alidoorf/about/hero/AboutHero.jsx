...
const AboutHero = () => {
    ...
    useEffect(() => {
        setTitRu(result?.data?.ali_about_hero_tit_ru)
        setTitEn(result?.data?.ali_about_hero_tit_en)
        setTitUz(result?.data?.ali_about_hero_tit_uz)
    }, [result, effect])


    return (
        <AdminForm
            value='ali_about_hero_tit'
            valueRu={titRu}
            valueEn={titEn}
            valueUz={titUz}
            setValueRu={setTitRu}
