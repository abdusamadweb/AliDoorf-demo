...
const NewsTitles = () => {
    ...
    useEffect(() => {
        setSubRu(result?.data?.ali_news_sub_ru)
        setSubEn(result?.data?.ali_news_sub_en)
        setSubUz(result?.data?.ali_news_sub_uz)

        setTitRu(result?.data?.ali_news_tit_ru)
        setTitEn(result?.data?.ali_news_tit_en)
        setTitUz(result?.data?.ali_news_tit_uz)
    }, [result, effect])
