...
const SecondaryColor2 = () => {
    ...
    useEffect(() => {
        setColor(result?.data?.color_secondary2_light)
        setColor2(result?.data?.color_secondary2_dark)
    }, [result, effect])


    const postColor = () => {
        const item = {
            key: 'color_secondary2_light',
            valueRu: color,
            valueEn: color,
            valueUz: color,
        }
    ...
    return (
        <form className='form' onSubmit={postData}>
            <div className='colors__title fw500 fz20 mb1'>Secondary color 2</div>
            <label>
...
export default SecondaryColor2
